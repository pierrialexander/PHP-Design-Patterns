...
/**
 * Classe Criteria é responsável por construir critérios de consulta dinâmica para serem usados em consultas SQL.
 * Ela permite definir filtros, condições e lógica de combinação de filtros, tornando possível criar consultas SQL flexíveis e parametrizadas.
 * Esta classe é parte do framework para manipulação de bancos de dados e transações.
